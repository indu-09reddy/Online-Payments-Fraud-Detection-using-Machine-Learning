...
Create project directories: The project expects the following directory structure. These should have been created for you.
...
Ensure you have downloaded the dataset and placed it in the data/ directory as PS_20174392719_1491204439457_log.csv.
...
Copy the payments.pkl file from the training/ directory to the flask/ directory.
cp training/payments.pkl flask/payments.pkl
Navigate to the flask/ directory:
cd flask
Run the Flask application:
python app.py
Open your web browser and go to the URL provided in the terminal (usually http://127.0.0.1:5000/ or http://localhost:5000/).
Project Structure
.
├── data/
